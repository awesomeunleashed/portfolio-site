  ...
  return (
    <>
      ...
      <p>
        ...
        building joke apps and participating in game jams. I strive towards
      ...
      <p>
        I have spent my career so far working on a range of software, but game
        development has been what I&apos;ve enjoyed most ever since I first
        learned programming for my Game Design and Development degree. Since
        then, I have been driven to constantly improve my coding skills. I never
        want to be trapped by the mindset of thinking something is impossible
