...
const ProjectLink = ({ description, index, name, path }: ProjectLinkProps) => {
  const className =
    "flex flex-col w-min max-w-full border border-stone-500 items-center space-y-4 bg-gradient-to-b from-cyan-900 to-cyan-950 px-4 py-3 sm:px-6 sm:py-5 text-center transition-colors hover:from-cyan-800 hover:to-cyan-900";
  const children = (
    <>
